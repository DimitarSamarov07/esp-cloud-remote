...
#define RMT_TX_GPIO    19  // IR Transmitter Pin
...
void send_ir_signal(rmt_symbol_word_t *data, size_t length) {
    ...
    ESP_ERROR_CHECK(rmt_transmit(tx_channel, bytes_encoder, data, length * sizeof(rmt_symbol_word_t), &tx_config_struct));
...
void rmt_rx_task(void *arg) {
    ...
    rmt_receive_config_t receive_config = {
        .signal_range_min_ns = 500 * 1000,  // Min pulse width (500 µs)
        .signal_range_max_ns = 10000 * 1000 // Max pulse width (10 ms)
    };
