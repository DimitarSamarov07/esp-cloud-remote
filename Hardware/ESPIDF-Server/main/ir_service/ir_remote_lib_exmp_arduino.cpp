...
#include <esp_err.h>
#include <nvs_flash.h>
#include "../components/IRRemote/src/IRremote.hpp"
...
void setup()
{
    ...
    IrReceiver.begin(10, true, 48);

    Serial.print(F("Ready to receive IR signals of protocols: "));
    printActiveIRProtocols(&Serial);
    Serial.println(F("at pin "));

    IrSender.begin(11, true, 48);
    ...
    Serial.print(F("Ready to send IR signals at pin " " on press of button at pin "));
    Serial.println(12);
}
